...
<body>
  ...
  <div class="container">
    ...
    <form action="./addDb.php" method="POST">
      <div class="card" style="margin-top: 600px; padding: 0;">
        <img style="border-radius: 10px;" src="./assets/images/head.png" alt="">
      </div>

      <div class="card">
        <h3 style="margin-bottom: 0;">Запись, на экскурсию в МБОУ СШ № 7</h3>
        <p><b>Время</b> с 19:00 <br>
          <b>Адрес:</b> 163002, г. Архангельск, территориальный округ Майская горка ул.<br>
          Карпогорская, д. 36<br>
          <b>Контакты:</b>
          8 (921) 720 79-69 - Илья Игоревич,<br>
      ...
      <div class="action">
        <button type="submit" class="action-button" style="cursor: pointer; margin-bottom: 100px;">Записаться</button>
      </div>
    </form>
  </div>

  <script>
    let butCol = document.querySelectorAll('#butCol');

    butCol.forEach(function(el) {
      el.addEventListener('click', function(e) {
        el.classList.remove('active');
        el.classList.add('active');
        dataZa.value = el.value;
      });
    });
  </script>
